                ...
                if !searchViewModel.searchTitles.isEmpty {
                  VStack(alignment: .leading, spacing: 15) {
                    ...
                    LazyVGrid(columns: columns, spacing: 12) {
                      ForEach(searchViewModel.searchTitles, id: \.stableDisplayID) { title in
                        let searchSourceID = "search_\(title.stableDisplayID)"
                          NavigationLink(destination:
                            TitleDetailView(
                              title: title,
                              zoomNamespace: heroNamespace,
                              zoomSourceID: searchSourceID
                            )
                          ) {
                           PosterCard(
                              title: title,
        ...
        if searchText.isEmpty {
          Button(action: {
            ...
            Image(systemName: "chevron.left")
              ...
              .liquidGlassIconPill(minWidth: 58, height: 38, fillOpacity: 0.18)
          }
          .foregroundStyle(.white)
          ...
          if !searchText.isEmpty {
            Button(action: {
              ...
              Image(systemName: "xmark")
                ...
                .liquidGlassIconPill(minWidth: 34, height: 26, fillOpacity: 0.12)
            }
          }
        }
